...
--       -- let updatedDescription = updatePackageDescription
--       --                     (Just bi, [(unqualComponentName "runtests", bi)]) (localPkgDescr lbi)
--       let updatedDescription = localPkgDescr lbi
--       putStrLn $ "Package description: " ++ show updatedDescription
--       return lbi {
--         localPkgDescr = updatedDescription
--       }
-- }
